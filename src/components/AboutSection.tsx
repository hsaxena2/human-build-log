      ...
      <div className="container mx-auto max-w-4xl px-6">
        ...
        <div className="prose prose-lg max-w-none space-y-6">
          <p className="text-lg leading-relaxed">
            I'm <strong>Himanshu Saxena</strong> — I've built growth and storytelling engines for SaaS and AI products, from early-stage startups to enterprise launches.
            But what I care about most now is <strong>why we build</strong> — and how people at the top keep their clarity when everything depends on them.
          </p>
          <p className="text-lg leading-relaxed">
          ...
          <div className="flex flex-wrap gap-4 mt-8 text-base">
            <a 
